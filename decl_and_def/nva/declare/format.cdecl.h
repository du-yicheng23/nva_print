...
nva_FmtStatus nva_long(long value, nva_FmtStatus status);
nva_FmtStatus nva_ulong(unsigned long uvalue, nva_FmtStatus status);
nva_FmtStatus nva_llong(NVA_LONG_LONG value, nva_FmtStatus status);
nva_FmtStatus nva_ullong(unsigned NVA_LONG_LONG uvalue, nva_FmtStatus status);
